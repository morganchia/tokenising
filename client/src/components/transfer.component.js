...
import OpsRoleDataService from "../services/user_opsrole.service";
...
//    console.log("Start > End? "+ (this.state.startdate > this.state.enddate));
    ...
    if (err !== '') {
      ...
      */
      this.displayModal(err, null, null, "OK");
...
/*
          showm: true, 
          modalmsg: "Transfer success", 
          button1text: "OK",
          button2text: null,
          button0text: null,
*/
        });
        this.displayModal("Transfer success", "OK", null, null);
      ...
      .catch(e => {
        ...
        if (e.response.data.message !== "") 
          this.displayModal("Error: "+e.response.data.message+". Please contact tech support.", null, null, "OK");
        else
          this.displayModal("Error: "+e.message+". Please contact tech support.", null, null, "OK");
  ...
  getAllMakersCheckersApprovers() {
    OpsRoleDataService.getAllMakersCheckersApprovers()
      .then(response => {
  ...
  componentDidMount() {
    ...
    this.getAllMakersCheckersApprovers();

  }

  showModal_Leave = () => {
    this.displayModal("You have made changes. Are you sure you want to leave this page without submitting?", 
                  "Yes, leave", null, "Cancel");
/*
    this.setState({ 
              showm: true, 
              modalmsg: "You have made changes. Are you sure you want to leave this page without submitting?", 
              button1text: "Yes, leave",
              button2text: null,
              button0text: "Cancel",
            });
*/
  ...
  displayModal(msg, b1text, b2text, b0text) {
    this.setState({
      showm: true, 
      modalmsg: msg, 
      button1text: b1text,
...
*/  
                ...
                { (this.state.datachanged) ? 
                  ...
                  <Modal showm={this.state.showm} handleProceed1={event =>  window.location.href='/dashboard'} handleProceed2={null} button1text={this.state.button1text} button2text={this.state.button2text} button0text={this.state.button0text} handleCancel={this.hideModal}>
                    {this.state.modalmsg}
                  </Modal>
