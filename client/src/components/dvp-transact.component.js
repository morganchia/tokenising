      ...
      return (
        <div className="container">
          ...
          <header className="jumbotron col-md-8">
            <h3>
              <strong>{this.state.currentDvP.txntype===0?"Execute ":""} DvP Transaction { this.state.isMaker? "(Maker)": (this.state.isChecker? "(Checker)": (this.state.isApprover? "(Approver)":null) )}</strong>
            </h3>
          </header>
...
//                  ))
  ...
  &nbsp;
                  ...
                  <Modal showm={this.state.showm} handleProceed1={event =>  window.location.href='/dvp'} handleProceed2={this.deleteDvP} handleProceed3={this.dropRequest} button1text={this.state.button1text} button2text={this.state.button2text} button3text={this.state.button3text} button0text={this.state.button0text} handleCancel={this.hideModal}>
                    {this.state.modalmsg}
                  </Modal>
