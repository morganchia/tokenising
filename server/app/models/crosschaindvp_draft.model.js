module.exports = (sequelize, Sequelize) => {
  const CrossChainDvP_Draft = sequelize.define("crosschaindvps_draft", {
    id: {
    ...
    approvedcrosschaindvpid: {
      type: Sequelize.INTEGER  // reference the id in CrossChainDvP table
    },
    startlegstatus: {
